                        ...
                        <div className='cursor-pointer hover:bg-zinc-800/50 p-3 rounded-md transition-colors group' key={user._id} >
                            <div className='flex items-start gap-3'>
                                <div className='relative'>
                                    ...
                                    <div className={`absolute bottom-0 right-0 w-3 h-3 rounded-full border-2 border-zinc-900 ${isPlaying ? "bg-green-500" : "bg-zinc-500"}`} aria-hidden='true' />
                                </div>
...
export default FreiendActivity
